...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="group relative flex h-10 w-10 items-center justify-center rounded-2xl border border-border bg-card text-muted-foreground shadow-sm transition-all duration-300 hover:scale-105 hover:border-indigo-300 hover:text-indigo-600 active:scale-95 dark:hover:border-indigo-700 dark:hover:text-indigo-400"
